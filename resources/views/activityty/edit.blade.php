                    ...
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            <li class="breadcrumb-item">
                                ...
                                <li class="breadcrumb-item"><a href="#!">แก้ไขผู้ใช้</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    {!! Form::hidden('id', $user->id) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10 col-xl-10 m-b-15">
                                                {!! Form::select('role_id', $selectrole, $selectedrole
                                                    ,['class' => 'form-control form-control-defualt','placeholder' => '-- เลือกตำแหน่ง --'] ) !!}
