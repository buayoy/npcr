										...
										<table id="simpletable" class="table table-striped table-bordered nowrap">
											...
											<tbody>
												...
												<tr>
													...
													<td></td>
													<td>
														<a href="#"><button class="btn btn-success btn-sm"><i class="ion-edit"></i>ยอมรับ</button></a>
														<a href="#" class="btn btn-danger btn-sm" onclick="approve();"><i class="ion-trash-a"></i>ลบ</a>
													</td>
												</tr>
												@php $i++; @endphp
												@endforeach
...
@section('footerScript')
	...
	<script>
		$(document).ready(function() {
            ...
            document.getElementById('menuactivity').classList.add('pcoded-hasmenu');    
            document.getElementById('menuactivity').classList.add('pcoded-trigger'); 
		});
	</script>
@endsection
